  ...
  return (
    <div className="rounded-div my-12 py-8">
      <div className="flex py-8">
        <img className="w-20 mr-10" src={coin.image?.large} alt="/" />
        <div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex py-4 justify-between">
            ...
            <div>
              <p className="text-gray-500 text-sm">Liquidity Score</p>
          ...
          <div>
            <div className="flex justify-around p-8 text-accent">
              <a
                href={`https://twitter.com/${coin?.name}`}
                target="_blank"
              ...
              <a
                href={`https://www.facebook.com/search/top/?q=${coin?.name}`}
                target="_blank"
                rel="noopener noreferrer"
              >
                <FaFacebook />
